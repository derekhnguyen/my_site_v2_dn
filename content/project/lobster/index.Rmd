...
![](https://video-images.vice.com/_uncategorized/1487868463815-lobster-underwater-photo-by-kate-mansury_29985017702_o.jpeg?resize=1050:*)
...
![](https://caseagrant.ucsd.edu/sites/default/files/i5lp9wkf-recipe-db.jpg)
...
```{r, include = FALSE}
lobster_abundance <- read_csv(here::here("csv", "lobster_abundance_sbc_lter.csv"
                              ), na = "-99999") %>% 
  clean_names() 
```
